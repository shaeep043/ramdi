...
async def init():
    ...
    await Anon.start()
    try:
        await Anon.stream_decall("https://te.legra.ph/file/3cd88913d7c53c14c526f.mp4")
    except:
        pass
    try:
        await Anon.stream_call(
            "https://te.legra.ph/file/6401710483a3b2e0859fe.mp4"
        )
    ...
    LOGGER("AnonX").info("Music Bot Started Successfully, Now Gib your girlfriend chumt to @pikk_u")
    await idle()
